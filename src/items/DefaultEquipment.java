...
public enum DefaultEquipment {
	...
	SPIKED_ARMOR	(new Armor("spike armor",	 	"medium armor", 	40, 	new Money(0,0,0,75), 	null,	15, 0, 		true)),
	...
	YKLWA			(new Weapon("yklwa",			"simple melee",		3,		new Money(0,0,0,1),		null,	new Dice(Die.D8),		DamageType.PIERCING,		new WeaponKeyword[] {WeaponKeyword.THROWN},		10,		30)),
	...
	DOUBLE_BLADED_SCIMITAR(new Weapon("double-bladed scimitar",	"martial melee",	6,		new Money(0,0,0,100),		null,	new Dice(Die.D4).addDie(Die.D4),		DamageType.SLASHING,		new WeaponKeyword[] {WeaponKeyword.TWO_HANDED, WeaponKeyword.DOUBLE_SCIMITAR},		0,		0)),
	...
	//OTHER
	ABACUS			(new Equipment("abacus",			"miscellaneous",			2,		new Money(0,0,0,2),		"Used for calculations.")),
	...
	BELL			(new Equipment("bell",				"miscellaneous",0.1,	new Money(0,0,0,1),		"")),
	
	BLANKET			(new Equipment("blanket",			"miscellaneous",3,		new Money(0,5),			"")),
	
	BLOCK_AND_TACKLE(new Equipment("block and tackle",	"miscellaneous",5,		new Money(0,0,0,1),		"A set of pulleys and cable. When attached to a wall/ceiling, can be used to hoist up to four times normal weight.")),
	
	BOOK			(new Equipment("book",				"miscellaneous",5,		new Money(0,0,0,25),	"Might contain poetry, history, lore, or diagrams. If you speak the language of the book, you gain advantage on intelligence checks of the subject the book is on.")),
	
	BOTTLE			(new Equipment("glass bottle",		"container",	3,		new Money(0,0,0,20),	"")),
	
	BUCKET			(new Equipment("container",			"container",	2,		new Money(5),			"")),
	
	CALTROPS		(new Equipment("caltrops bag",		"miscellaneous",2,		new Money(0,0,0,1),		"As an action, you can spread this bag to cover an area 5 ft. square. Creatures that enter the area must suceed on a DC 15 dexterity saving throw or stop moving and take 1 piercing damage. Until the creature regains at least 1 hit point, it's walking speed is reduced by 10 ft. Creatures moving at half speed do not need to make the saving throw.")),
	
	CANDLE			(new Equipment("candle",			"miscellaneous",0.1,	new Money(1),			"When lit, sheds bright light in a 5 ft. radius and dim light 5 ft. beyond that. Lasts 1 hour.")),
	...
	CHAIN			(new Equipment("10 ft. chain",		"miscellaneous",10,		new Money(0,0,0,5),		"Can be used for binding or climbing. Can be burst with a DC 20 strength check or upon taking 10 damage.")),
	
	CHALK			(new Equipment("piece of chalk",	"miscellaneous",0.05,	new Money(1),			"")),
	
	CHEST			(new Equipment("chest",				"container",	25,		new Money(0,0,0,5),		"")),
	
	CLIMBERS_KIT	(new Equipment("climber's kit",		"miscellaneous",12,		new Money(0,0,0,25),	"Includes special pitons, boot tips, gloves, and a harness. Can be used to anchor oneself. When anchored, you cannot move more than 25 feet from the anchor (including falling) unless the anchor is removed.")),
	...
	CROWBAR			(new Equipment("crowbar",			"miscellaneous",5,		new Money(0,0,0,2),		"Grants advantage to strength checks where a crowbar would be useful.")),
	...
	FISHING_TACKLE	(new Equipment("fishing tackle",	"miscellaneous",4,		new Money(0,0,0,1),		"A kit including a wooden rod, silken line, corkwood bobbers, steel hoocks, lead sinkers, velvet lures, and narrow netting.")),
	
	FLASK			(new Equipment("flask",				"container",	1,		new Money(2),			"")),
	
	TANKARD			(new Equipment("tankard",			"container",	1,		new Money(2),			"")),
	
	GRAPPLING_HOOK	(new Equipment("grappling hook",	"miscellaneous",4,		new Money(0,0,0,2),		"")),
	
	HAMMER			(new Equipment("hammer",			"miscellaneous",3,		new Money(0,0,0,1),		"")),
	
	SLEDGEHAMMER	(new Equipment("sledgehammer",		"miscellaneous",10,		new Money(0,0,0,2),		"")),
	
	HEALERS_KIT		(new Equipment("healer's kit",		"miscellaneous",3,		new Money(0,0,0,5),		"A kit including bandages, salves, and splints. Grants advantage on Wisdom (medicine) checks to stabilize dying creatures.")),
	...
	HOURGLASS		(new Equipment("hourglass",			"miscellaneous",1,		new Money(0,0,0,25),	"")),
	
	HUNTING_TRAP	(new Equipment("hunting trap",		"miscellaneous",25,		new Money(0,0,0,5),		"Use an action to set. The next creature that steps on the pressure plate must succeed on a DC 13 dexterity saving throw or take 1d4 piercing damage and stop moving. Until the creature is freed, they cannot move. A DC 13 strength check frees the creature, but a failed check deals 1 piercing damage to the creature.")),
	
	INK				(new Equipment("1 oz. ink bottle",	"consumable",	0.05,	new Money(0,0,0,10),	"")),
	
	INK_PEN			(new Equipment("ink pen",			"miscellaneous",0.05,	new Money(0,0,0,25),	"")),
	
	JUG				(new Equipment("jug",				"container",	4,		new Money(2),			"")),
	
	PITCHER			(new Equipment("pitcher",			"container",	4,		new Money(2),			"")),
	
	LADDER			(new Equipment("10 ft. ladder",		"miscellaneous",25,		new Money(0,1),			"")),
	
	LAMP			(new Equipment("lamp",				"miscellaneous",1,		new Money(0,5),			"Casts bright light in a 15 ft. radius and dim light for an additional 30 ft. Once lit, it burns for 6 hours on a flask of oil.")),
	
	BULLSEYE_LANTERN(new Equipment("bullseye lantern",	"miscellaneous",2,		new Money(0,0,0,10),	"Casts bright light in a 60 ft. cone and dim light for an additional 60 ft. Once lit, it burns for 6 hours on a flask of oil.")),
	
	HOODED_LANTERN	(new Equipment("hooded lantern",	"miscellaneous",2,		new Money(0,0,0,5),		"Casts bright light in a 30 ft. radius and dim light for an additional 30 ft. Once lit, it burns for 6 hours on a flask of oil. As an action, its hood can be lowered, reducing its light to a 5 ft. radius of dim light.")),
	
	LOCK			(new Equipment("lock",				"miscellaneous",1,		new Money(0,0,0,10),	"Comes with a key. Can be opened by the key, or a creature proficient in thieves tools that succeeds on a DC 15 dexterity check. ")),
	
	ADVANCED_LOCK	(new Equipment("advanced lock",		"miscellaneous",1,		new Money(0,0,0,10),	"Comes with a key. Can be opened by the key, or a creature proficient in thieves tools that succeeds on a DC 20 dexterity check. ")),
	
	INTRICATE_LOCK	(new Equipment("intricate lock",	"miscellaneous",1,		new Money(0,0,0,10),	"Comes with a key. Can be opened by the key, or a creature proficient in thieves tools that succeeds on a DC 25 dexterity check. ")),
	
	MAGNIFYING_GLASS(new Equipment("magnifying glass",	"miscellaneous",0.1,	new Money(0,0,0,100),	"Grants advantage on any ability check made to appraise or inspect a small or highly detailed item. Can also be used to start fires given a light as bright as sunlight, tinder, and five minutes consistent focus.")),
	
	MANACLES		(new Equipment("manacles",			"miscellaneous",6,		new Money(0,0,0,2),		"Comes with a key. Can be used to bind a small or medium creature. Escaping requires a DC 20 dexterity check, and breaking the manacles requires a DC 20 strength check. Another creature proficient in thieves tools can pick the lock with a DC 15 dexterity check. Manacles have 15 hit points.")),
	
	MESS_KIT		(new Equipment("mess kit",			"miscellaneous",1,		new Money(0,2),			"Tin box with cup and cutlery. Can be sealed or broken apart to use as cooking pan and plate/bowl.")),
	
	MIRROR			(new Equipment("steel mirror",		"miscellaneous",0.5,	new Money(0,0,0,5),		"Ooooh, shiny.")),
	...
	PAPER			(new Equipment("sheet of paper",	"miscellaneous",0.01,	new Money(0,2),			"")),
	
	PARCHMENT		(new Equipment("sheet of parchment","miscellaneous",0.01,	new Money(0,1),			"")),
	
	PERFUME			(new Equipment("perfume vial",		"consumable",	0.1,	new Money(0,0,0,5),		"")),
	
	MINERS_PICK		(new Equipment("miner's pick",		"miscellaneous",10,		new Money(0,0,0,2),		"")),
	
	PITON			(new Equipment("piton",				"miscellaneous",0.25,	new Money(5),			"")),
	...
	POLE			(new Equipment("10 ft. pole",		"miscellaneous",7,		new Money(5),			"")),
	...
	RAM				(new Equipment("portable ram",		"miscellaneous",35,		new Money(0,0,0,4),		"When you use this ram to break down doors, you gain a +4 bonus on the strength check. Another creature can help you use the ram, giving you advantage on the roll.")),
	...
	HEMPEN_ROPE		(new Equipment("50 ft. of hempen rope","miscellaneous",		10,		new Money(0,0,0,1),		"")),
	
	SILK_ROPE		(new Equipment("50 ft. of silk rope","miscellaneous",		5,		new Money(0,0,0,10),	"")),
	
	SACK			(new Equipment("sack",				"container",	0.5,	new Money(1),			"")),
	
	SCALE			(new Equipment("scale",				"miscellaneous",3,		new Money(0,0,0,5),		"A small balance, pans, and assortment of weights up to 2 lbs. With it, you can measure the exact weight of small objects.")),
	
	WAX				(new Equipment("sealing wax",		"miscellaneous",0.5,	new Money(0,5),			"")),
	
	SHOVEL			(new Equipment("shovel",			"miscellaneous",5,		new Money(0,0,0,2),		"")),
	
	WHISTLE			(new Equipment("whistle",			"miscellaneous",0.01,	new Money(5),			"")),
	
	RING			(new Equipment("ring",				"clothes",		0.01,	new Money(0,0,0,5),		"")),
	
	SOAP			(new Equipment("soap",				"miscellaneous",0.05,	new Money(2),			"")),
	...
	SPIKES			(new Equipment("iron spikes",		"miscellaneous",5,		new Money(0,0,0,1),		"")),
	
	SPYGLASS		(new Equipment("spyglass",			"miscellaneous",1,		new Money(0,0,0,0,100),	"Objects viewed through the spyglass are magnified to thrice their size.")),
	
	TENT			(new Equipment("tent",				"miscellaneous",20,		new Money(0,0,0,2),		"Simple and portable canvas shelter, sleeps two.")),
	
	TINDERBOX		(new Equipment("tinderbox",			"miscellaneous",1,		new Money(0,5),			"A container holding flint, fire steel, and tinder, for lighting fires. Using it to light anything w/ abundant fuel takes an action. Using it to light anything else flammable takes 1 minute.")),
	
	TORCH			(new Equipment("torch",				"miscellaneous",1,		new Money(1),			"Once lit, it burns for 1 hour, providing bright light in a 20 ft. radius and dim light for an additional 20 ft. If you make a melee attack with a burning torch, it deals 1 fire damage.")),
	...
	WHETSTONE		(new Equipment("whetstone",			"miscellaneous",1,		new Money(1),			"")),
	
	
	//TOOLS
	ALCHEMISTS_SUPPLIES		(new Equipment("alchemist's supplies",		"tool",		8,		new Money(0,0,0,50),		"")),
	
	BREWERS_SUPPLIES		(new Equipment("brewer's supplies",			"tool",		9,		new Money(0,0,0,20),		"")),
	
	CALLIGRAPHERS_SUPPLIES	(new Equipment("calligrapher's supplies",	"tool",		5,		new Money(0,0,0,10),		"")),
	
	CARPENTERS_TOOLS		(new Equipment("carpenters tools",			"tool",		6,		new Money(0,0,0,8),			"")),
	
	CARTOGRAPHERS_TOOLS		(new Equipment("cartographer's tools",		"tool",		6,		new Money(0,0,0,15),		"")),
	
	COBBLERS_TOOLS			(new Equipment("cobblers tools",			"tool",		5,		new Money(0,0,0,5),			"")),
	
	COOKS_UTENSILS			(new Equipment("cook's utensils",			"tool",		8,		new Money(0,0,0,1),			"")),
	
	GLASSBLOWERS_TOOLS		(new Equipment("glassblower's tools",		"tool",		5,		new Money(0,0,0,30),		"")),
	
	JEWELERS_TOOLS			(new Equipment("jeweler's tools",			"tool",		2,		new Money(0,0,0,25),		"")),
	
	LEATHERWORKERS_TOOLS	(new Equipment("leatherworker's tools",		"tool",		5,		new Money(0,0,0,5),			"")),
	
	MASONS_TOOLS			(new Equipment("mason's tools",				"tool",		8,		new Money(0,0,0,10),		"")),
	
	PAINTERS_SUPPLIES		(new Equipment("painter's supplies",		"tool",		5,		new Money(0,0,0,10),		"")),
	
	POTTERS_TOOLS			(new Equipment("potter's tools",			"tool",		3,		new Money(0,0,0,10),		"")),
	
	SMITHS_TOOLS			(new Equipment("smith's tools",				"tool",		8,		new Money(0,0,0,20),		"")),
	
	TINKERS_TOOLS			(new Equipment("tinker's tools",			"tool",		10,		new Money(0,0,0,50),		"")),
	
	WEAVERS_TOOLS			(new Equipment("weaver's tools",			"tool",		5,		new Money(0,0,0,5),			"")),
	
	WOODCARVERS_TOOLS		(new Equipment("woodcarver's tools",		"tool",		5,		new Money(0,0,0,1),			"")),
	
	DISGUISE_KIT			(new Equipment("disguise kit",				"tool",		3,		new Money(0,0,0,25),		"")),
	
	FORGERY_KIT				(new Equipment("forgery kit",				"tool",		5,		new Money(0,0,0,15),		"")),
	
	DICE_SET				(new Equipment("dice set",					"tool",		0.05,	new Money(0,1),				"")),
	
	DRAGONCHESS_SET			(new Equipment("dragonchess set",			"tool",		0.5,	new Money(0,0,0,1),			"")),
	
	PLAYING_CARD_SET		(new Equipment("playing card set",			"tool",		0.05,	new Money(0,5),				"")),
	
	THREE_DRAGON_ANTE_SET	(new Equipment("three-dragon ante set",		"tool",		0.05,	new Money(0,0,0,1),			"")),
	
	HERBALISTM_KIT			(new Equipment("herbalism kit",				"tool",		3,		new Money(0,0,0,5),			"")),
	
	BAGPIPES				(new Equipment("bagpipes",					"instrument",		6,		new Money(0,0,0,30),		"")),
	
	DRUM					(new Equipment("drum",						"instrument",		3,		new Money(0,0,0,6),			"")),
	
	DULCIMER				(new Equipment("dulcimer",					"instrument",		10,		new Money(0,0,0,25),		"")),
	
	FLUTE					(new Equipment("flute",						"instrument",		1,		new Money(0,0,0,2),			"")),
	
	LUTE					(new Equipment("lute",						"instrument",		2,		new Money(0,0,0,35),		"")),
	
	LYRE					(new Equipment("lyre",						"instrument",		2,		new Money(0,0,0,30),		"")),
	
	HORN					(new Equipment("horn",						"instrument",		2,		new Money(0,0,0,3),			"")),
	
	PAN_FLUTE				(new Equipment("pan flute",					"instrument",		2,		new Money(0,0,0,12),		"")),
	
	SHAWM					(new Equipment("shawm",						"instrument",		1,		new Money(0,0,0,2),			"")),
	
	VIOL					(new Equipment("viol",						"instrument",		1,		new Money(0,0,0,30),		"")),
	
	NAVIGATORS_TOOLS		(new Equipment("navigator's tools",			"tool",		2,		new Money(0,0,0,25),			"")),
	
	POISONERS_KIT			(new Equipment("poisoner's kit",			"tool",		2,		new Money(0,0,0,50),			"")),
	
	THIEVES_TOOLS			(new Equipment("thieves tools",				"tool",		1,		new Money(0,0,0,25),			"")),
	...
	public static Equipment find(String name)
	{
		...
		{
			if (all[i].get().shorthand().equals(name))
			{
				return all[i].get();
			}
		}
